    ...
    public Bot3(int x, int y, int _size) {
        ...
        this.looper = new Timer(400, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(Bot3.this.startx == 0 && Bot3.this.starty == 0) Bot3.this.bestScore();
                ...
                if (Bot3.this.starty + Bot3.this.currentPentomino[0].length == 15 ) {
                    ...
                    if(!collide){
                        ...
                        if(Bot3.this.mutation != Bot3.this.destmut) Bot3.this.mutation++;
                        if(Bot3.this.starty != Bot3.this.desty) Bot3.this.starty++;
                ...
                if(Bot3.this.started) {
                    Bot3.this.repaint();
                    if (Bot3.this.starty + Bot3.this.currentPentomino[0].length == 15) {
                        Bot3.this.advanceToNextPentomino();
                    }
                }
            }
        });
